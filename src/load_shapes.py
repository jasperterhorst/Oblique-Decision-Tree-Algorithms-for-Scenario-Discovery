...
def load_shape_dataset(folder_name=None):
    """
    Loads CSV files from a folder inside the shapes directory. If a folder name is provided, it will be
    treated as a subfolder of DATA_DIR/shapes. If no folder name is provided, the function loads CSV files
    directly from DATA_DIR/shapes.
