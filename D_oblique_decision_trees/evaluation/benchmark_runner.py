...
from D_oblique_decision_trees.evaluation.io_utils import save_depth_sweep_df, save_trees_dict
...
class DepthSweepRunner:
    ...
    @staticmethod
    def build_registry(random_state=None, impurity=None, segmentor=None):
        """
