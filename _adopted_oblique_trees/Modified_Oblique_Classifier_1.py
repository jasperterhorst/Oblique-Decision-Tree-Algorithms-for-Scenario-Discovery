...
This module provides a modified implementation of the Oblique Classifier 1 (OC1)
decision tree algorithm, originally introduced by Murthy et al. (1994).
It builds upon the OC1 variant included in the "Ensembles of Oblique Decision
Trees" package by Torsha Majumder (2020), which diverged from Murthy's design
