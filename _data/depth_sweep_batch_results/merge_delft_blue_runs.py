...
input_dir = current_dir / "delftblue_sample_size_runs"
...
# 3. Read & concat without reordering
dfs = [pd.read_csv(f) for f in csv_files]
merged_df = pd.concat(dfs, ignore_index=True)

# 4. Save to current dir
output_path = current_dir / "sample_size_runs_concatenated.csv"
